...
/*
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO `student_feed_back` (`id`, `s_id`, `content`, `datetime`) VALUES (NULL, '$usr_id', '$feed_back', '$datetime');";
...
<head>
	<meta charset="UTF-8">
    <title>Sinh viên phản hồi tình trạng thực tập</title>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <p>Sinh viên chú ý phản hồi thực tập</p>
    <ol>
      <li>Nội dung thông tin phải chính xác</li>
      <li>Khuyến khích điền các thông tin chi tiết phục vụ cho các đợt thực tập sau</li>
      <li>Sinh viên nếu bị phát hiện cố ý làm sai lệch gây ảnh hưởng nghiêm trọng sẽ bị kỷ luật</li>
    </ol>

    <br/>
    
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSclplVwq_Mhh_C6TDD0GnwDqV5vq2oeg4X9V2nvKKHyiMj9fQ/viewform" width="100%%" height="768px" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
    </div>
