...
define('EMAIL_FOR_REPORTS', 'huynhld.spx@gmail.com');
...
<form enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:100%;min-width:150px" method="post"><div class="title"><h2>My form</h2></div>
